/// <reference types="cypress" />
 describe('Accountant RatracoSolutions', () => {  
    it ('Verify that user can login with valid username and password', () => {
       ...
       cy.get('.woka-chooseapps__app-logo').should('be.visible').click(); //{ timeout: 10000 }
       cy.get('[data-testid="MenuIcon"] > path').click();
       cy.get('.MuiDrawer-modal > .MuiPaper-root > .box-1 > .css-1hdfbzc > .MuiList-root > :nth-child(5) > .MuiListItemButton-root > .MuiListItemText-root > .MuiTypography-root').click();
